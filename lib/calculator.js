const Calculator = {
    ...
    compute(state, globalOffset = 1.0) {
        ...
        const range = (val, spread = 4, absoluteMax = 200) => {
            const v = Math.round(val);
        ...
        const results = {
            ...
            general: range(baseGeneral, 4, 200),
            redDot: range(redDot, 4, 200),
            scope2x: range(scope2x, 4, 200),
            scope4x: range(scope4x, 4, 200),
            sniperScope: range(sniper, 4, 200),
            freeLook: range(freeLook, 5, 200),
